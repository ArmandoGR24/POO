    ...
    public static void main(String[] args) {
       {
        ...
        switch(opcion)
        {
            ...
            case 1:
                ...
                catch(Exception e){JOptionPane.showMessageDialog(null, "Interacción Incorrecta");}
                finally{}
                break;
            ...
            case 2:
                ...
                catch(Exception a){JOptionPane.showMessageDialog(null, "Interacción Incorrecta");}
                finally{}
                break;
                //Caso para salir
            case 3: break;
